...
2. Select **Elevator** and click the lobby to connect the floor above, or drag across several floors. Leave four cells clear for standard/service shafts, or six for express shafts. **Stairs** can also be placed by clicking the lobby. New stairs and escalators require eight clear cells.
